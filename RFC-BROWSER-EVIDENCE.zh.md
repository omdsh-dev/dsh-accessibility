...
使用方：DSH `0.1.2-rc.1` 加 `dsh-v0.1.2-rc.1-a11y.5` 上的 Accessible View 与核心 P0 Web 路由；较早的 rc1 与 alpha.2 记录继续作为精确 revision 归档
...
只有每个必需测试进程以零退出、Schema 与语义清单校验通过，并且受测 commit 与记录 revision 相符时，记录才有效。脏工作树日志只能用于开发诊断，不能作为发布证据。第一份经过评审的核心记录归档于 [`33eb2d9e1e`](automated-evidence/core-browser/2026-08-31-dsh-0.1.2-alpha.2-33eb2d9e1e.json)；首轮活动精确候选另行生成于 [`5803bfcfdd`](automated-evidence/core-browser/2026-08-31-dsh-0.1.2-alpha.2-5803bfcfdd.json)；第一份 rc1 移植报告保留于 [`21859d968c`](automated-evidence/core-browser/2026-09-07-dsh-0.1.2-rc.1-21859d968c.json)，当前候选则在队列快照可移植性修复后于精确干净 revision [`1e7f105934`](automated-evidence/core-browser/2026-09-07-dsh-0.1.2-rc.1-1e7f105934.json) 上重新生成。四份记录都不得跨 revision 继承或互换使用。
