...
export function assertCompanionBaseline(dshManifest, pluginManifest) {
  ...
  if (pluginManifest.private === true) {
    throw new Error('Companion integration is blocked: identify the exact upstream core source, migrate and pin the accessibility core, then review the publication hold. See the current compatibility migration record.')
  }
}
