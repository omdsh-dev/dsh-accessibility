...
- Upgrade the disposable companion AT lab and assembled-browser consumer to `dsh-v0.1.2-rc.1-a11y.4`, including the one-use authenticated Web entry point and current seeded-history fixture.
