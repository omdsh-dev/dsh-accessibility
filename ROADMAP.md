...
- Tested DSH baseline: `@deepseek-ai/dsh@0.1.2-rc.1` plus `dsh-v0.1.2-rc.1-a11y.3`.
...
- Core browser evidence: clean rc1 revision `f298fa710585947317664e5d75c4069b209202de` has a schema-validated `dsh-core-browser-non-at` `pass` across Chromium, Firefox, and WebKit. Fourteen required checks cover all nine cataloged static P0 Web tasks plus menu and safety routes; this is automated non-AT evidence, while live states, real zoom/High Contrast, AT, and disabled-user rows remain pending. The alpha.2 campaign report remains separately archived and does not transfer.
