...
The archive retains the first reviewed `33eb2d9e1e` record, the separately regenerated `5803bfcfdd` record for the exact primary-campaign candidate, and the independent `33546ce7d8` report for the DSH `0.1.2-rc.1` accessibility port. Later commits do not inherit any result automatically.
